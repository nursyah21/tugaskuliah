...
<section class="container my-4">
    <div>
        <div class="has-text-centered">
            <h1 class="title is-2">Hapus Data mahasiswa - id {{$data->id}}</h1>
        </div>
    ...
    <div class="mt-2 is-justify-content-center is-align-items-center">
            <form action="/delete?id={{$data->id}}" method="post" class="columns is-flex is-flex-direction-column box">
                @csrf
                @method('DELETE') 
                ...
                <div class="column">
                    <button class="button is-danger is-fullwidth" type="submit">Hapus Data Mahasiswa</button>
                </div>
